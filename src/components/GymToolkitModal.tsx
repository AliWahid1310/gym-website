...
const TOOLKIT_ITEMS: QuickToolItem[] = [
  {
    id: "plate-calc",
    name: "Olympic Barbell Plate Calculator",
    category: "Calculators",
    icon: "🏋️",
    description: "Visual barbell loading rack and color-coded bumper plate breakdown per side.",
    targetId: "plate-calculator",
    badge: "Barbell 3D",
  },
  {
    id: "member-pass",
    name: "Digital Member ID Pass Wallet",
    category: "Community",
    icon: "💳",
    description: "Interactive 3D turnstile check-in card, QR scanner, and VIP club status.",
    targetId: "member-wallet",
    badge: "NFC & QR",
  },
  {
    id: "tempo-metronome",
    name: "Rep Tempo & Cadence Metronome",
    category: "Workouts",
    icon: "🎵",
    description: "Audio metronome and pulse ring for eccentric, pause, and explosive concentric reps.",
    targetId: "tempo-metronome",
    badge: "Audio Web API",
  },
  {
    id: "workout-logger",
    name: "Gym Set Logger & PR Tracker",
    category: "Workouts",
    icon: "📝",
    description: "Log working sets, RPE ratings, calculate total tonnage volume, and celebrate PRs.",
    targetId: "workout-logger",
    badge: "PR Tracker",
  },
  {
    id: "ramadan-guide",
    name: "Ramadan Fasting & Gym Protocol",
    category: "Nutrition",
    icon: "🌙",
    description: "Pakistani athlete hydration schedules, Post-Taraweeh training, and high-protein meals.",
    targetId: "ramadan-guide",
    badge: "Pakistani Protocol",
  },
  {
    id: "timer",
